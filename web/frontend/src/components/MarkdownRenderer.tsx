    ...
    <div className="prose dark:prose-invert max-w-none">
      <ReactMarkdown
        ...
        components={{
          ...
          h1: (props) => <h1 className="text-primary text-2xl font-bold mt-6 mb-3" {...props} />,
          h2: (props) => <h2 className="text-primary text-xl font-semibold mt-5 mb-2" {...props} />,
          h3: (props) => <h3 className="text-primary text-lg font-medium mt-4 mb-1" {...props} />,
          ...
          blockquote: (props) => <blockquote className="border-l-4 border-border pl-4 py-2 italic text-muted-foreground" {...props} />,
